...
def tail(input_list):
    ...
    """
    # return slice of input list from [1:]
    return input_list[1:]
...
def last_five(input_list):
    ...
    """
    #slice the list from -5 to the end
...
def inner_four_end(input_list):
    ...
    """
    # return slice from index at -6 to -2
...
def replace_third_and_last(input_list):
    ...
    """
    # replace at index 2 and at index -1
    input_list[2] = 37
    input_list[-1] = 37
